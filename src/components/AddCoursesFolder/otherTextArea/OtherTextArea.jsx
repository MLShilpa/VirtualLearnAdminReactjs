...
const OtherTextArea = (props) => {
    ...
    fetch("https://api.cloudinary.com/v1_1/deiz877la/video/upload", {
      ...
      .then((data) => {
        ...
        data?.original_filename &&
          setOriginalFileName(data?.original_filename + "." + data?.format);
  ...
  function uploadPhoto(e) {
    ...
    fetch("https://api.cloudinary.com/v1_1/deiz877la/image/upload", {
      method: "post",
      body: data,
    })
      .then((res) => res.json())
  ...
  return (
    <>
      ...
      <div>
        ...
        <img src={props.photo} className="showImage" alt="image" />
      </div>
      <div>
            ...
            <div className="browse">
              <input
                ...
                onChange={(e) => {
                  ...
                  uploadVideoPreview(e);
                  dispatch(
                    storeoverViewVideo({ videoUpload: e.target.files[0].name })
                  );
                }}
                accept="video/*"
                autoComplete="off"
